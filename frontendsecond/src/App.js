...
import AdminHomeSecond from "./admin_components/AdminHomeSecond";
import AdminActivityTable from "./admin_components/AdminActivityTable";
...
import AdminManageHeaderSecond from "./admin_components/AdminManageHeaderSecond";
    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<PublicLayout />}>
          <Route index element={<HomeSecond />} />
        ...
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="/admin/homesecond" element={<AdminHomeSecond />} />
          <Route path="/admin/activitiestable" element={<AdminActivityTable />} />
          ...
          <Route path="/admin/manage-headersecond" element={<AdminManageHeaderSecond />} />
