...
//     try {
//       const res = await api.get(`/api/main-site-popup?schoolId=1`);
...
//     try {
//       await api.put(`/api/admin-main-popup/update/${popup._id}`, popup);
...
//         onChange={(e) => setPopup({ ...popup, backgroundImage: e.target.value })}
//       />

//       <label>Status</label>
//       <select
//         value={popup.status}
//         onChange={(e) => setPopup({ ...popup, status: e.target.value === "true" })}
//       >
