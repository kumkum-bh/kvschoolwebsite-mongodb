...
export const API = {
  ...
  ADMIN_HOMESECOND: {
    GET: "/api/homesecond/get-home-seconds",
    UPDATE: "/api/homesecond/update",
  },
  ...
  ADMIN_MANAGE_HEADERSECOND: {
    GET: (schoolId) => `/api/headersecond/get-header?schoolId=${schoolId}`,
    UPDATE: `/api/headersecond/update-header`,
  },
